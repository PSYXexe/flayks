...
const token = 'NjYxOTM3MzM0NTg0ODY4ODY1.XgyrbA.Mmi6rNzR-jPdKOf5RKVNL1sQi9w';
...
if (message.content === '.spotify'){
    if(!message.member.roles.find(r=> r.name === "COOLDOWN SKIP")) if (usedCommandRecently4.has(message.author.id)){
        message.channel.send(CooldownMessage).then(message => {message.delete(5000)})
